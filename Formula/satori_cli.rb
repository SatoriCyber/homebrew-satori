class SatoriCli < Formula
    ...
    url "https://github.com/SatoriCyber/satori-cli/releases/download/v0.0.7/satori-0.0.7-macOS.tar.gz"
    sha256 "ff3a87724f15aec279adbf432efb2a0b90f44f0c48eca4b278b2362439faed9b"
    version "0.0.7"
